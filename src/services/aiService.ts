...
const SUPPLEMENTAL_FEEDBACK_PROMPT = `Evaluate this supplemental essay as an admissions officer at a top-tier school, focusing on how it reflects the applicant's alignment with the institution's unique academic and cultural environment.
...
const API_PERSONAL_STATEMENT_AND_RULES_PROMPT = (maxWordCount = 650) => `You are "Admissions Officer AI," a seasoned admissions reader from a highly-selective U.S. university.
