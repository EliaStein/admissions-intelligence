...
import { FileText, Calendar, PenLine, X, CreditCard, Plus, CheckCircle } from 'lucide-react';
...
function PaymentSuccessModal({ onClose }: PaymentSuccessModalProps) {
      ...
      <div className="bg-white rounded-lg shadow-xl w-full max-w-md" onClick={(e) => e.stopPropagation()}>
        <div className="p-6 text-center">
          ...
          <p className="text-gray-600 mb-6">
            Your credits have been added to your account. You can now use them to get AI feedback on your essays.
          </p>
