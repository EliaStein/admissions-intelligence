...
import { CreditCard, Check, ArrowLeft, Star } from 'lucide-react';
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Individual credits are $49 (50% off from $99). Save even more with packages:
                      5 reviews for $200 (60% off) or 10 reviews for $350 (65% off).
                    </p>
                  </div>
                </div>
